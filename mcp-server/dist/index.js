...
async function apiGet(path, needAuth) {
...
server.registerTool("tennis_backend_ping", {
...
server.registerTool("tennis_list_courts", {
...
server.registerResource("platform_help_hint", "tennis://docs/help", {
    ...
    contents: [
        {
            ...
            mimeType: "text/plain",
            text: "场地列表、预约、支付等以 Spring Boot 业务 API 与 LangChain 工具为准；" +
